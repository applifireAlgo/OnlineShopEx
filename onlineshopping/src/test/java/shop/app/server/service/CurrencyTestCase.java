...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("6K22jaHXd4MNb6vldzugQRuKbR8ypG4F");
            country.setCapitalLatitude(9);
            country.setCapitalLongitude(9);
            country.setCountryCode1("sUZ");
            country.setCountryCode2("vrY");
            country.setCountryFlag("1uQd8vbhFyZwNnQuTBbZPLM6aL6OCvD5EVQwqu6GiGViyS9NQd");
            country.setCountryName("YdHgVbvcqdQO4riAfFWrNNAqv0PMLqx3JVrsJY1fdCoUzdOuAW");
            country.setCurrencyCode("cZh");
            country.setCurrencyName("7mGFXBu8WrfqW6tMjE1eyC6InQvCV8rDfJ0XGTjuZECXyUCWfD");
            country.setCurrencySymbol("GRcLE31S6jBKEDzy0eLN8SgPDzZU2AlO");
            country.setIsoNumeric(1);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("4KzxVxzFFTNuXtqgmxOGaxGrgNptID0jYhAKyzH4u6DfPZxIKK");
            currency.setUnicodeDecimal("R8LDkZnRzh5k0p3lUlQ0DImrVfkzUjpnFDEedJP9dtqNX8NRMI");
            currency.setUnicodeHex("kepMjVvr9TMU3fFjyk9UYutvN6XltXXgmp1XOgBP9ASsOw2cLr");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("8fWEWwR0gTVpWtJ0icVU0ESuDgkSGUf5LrDH6spW7ziue1aGyb");
            currency.setUnicodeDecimal("mVAIDGAVFGAnjn2Sxkd6UR3VmpfGoHTJNE89rB5XOXTznjvyQU");
            currency.setUnicodeHex("yu3FMtY8ZqGpkstiwRN3o7LHxmKkI6JjZw6u3gb1hdUSqLIViC");
