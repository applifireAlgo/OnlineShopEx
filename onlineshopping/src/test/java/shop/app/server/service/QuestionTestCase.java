...
import shop.app.server.repository.QuestionRepository;
...
public class QuestionTestCase {
    ...
    public void test1Save() {
        try {
            ...
            question.setQuestion("0DSmrERbStMwiZaWVqbrmRweriePhFzH3786MewZnwByOjXpQH");
            question.setQuestionDetails("i5A");
            question.setQuestionIcon("0N3rouzS7bRiN2hZxBBIBUFg93Kxat2UJ4aAacNUya37tx9BcU");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("qBXJmUudZjZwSHjyoIAq6aexerMmZIFHw8xRrZuqmx0vwCgAgq");
            question.setQuestionDetails("SXP");
            question.setQuestionIcon("5f3gP6NqFxoFPkOxhXyPTyLLEKZIvHgKBZ7ZzDACauc8sbmlJY");
