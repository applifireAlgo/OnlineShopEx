...
public class LoginRepositoryImpl extends SearchInterfaceImpl implements LoginRepository<Login> {
    ...
    public List<Login> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<shop.app.shared.authentication.Login> query = emanager.createQuery("select u from Login u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Login> save(List<Login> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                shop.app.shared.authentication.Login obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            shop.app.shared.authentication.Login s = emanager.find(shop.app.shared.authentication.Login.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<Login> findByUserId(String userId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<shop.app.shared.authentication.Login> listOfLogin = query.getResultList();
            return listOfLogin;
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Login findById(String loginPk) throws Exception, SpartanPersistenceException {
        try {
            ...
            shop.app.shared.authentication.Login listOfLogin = (shop.app.shared.authentication.Login) query.getSingleResult();
            return listOfLogin;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
