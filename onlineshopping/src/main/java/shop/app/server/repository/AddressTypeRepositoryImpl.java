...
public class AddressTypeRepositoryImpl extends SearchInterfaceImpl implements AddressTypeRepository<AddressType> {
    ...
    public List<AddressType> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<shop.app.shared.location.AddressType> query = emanager.createQuery("select u from AddressType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<AddressType> save(List<AddressType> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                shop.app.shared.location.AddressType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            shop.app.shared.location.AddressType s = emanager.find(shop.app.shared.location.AddressType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public AddressType findById(String addressTypeId) throws Exception, SpartanPersistenceException {
        try {
            ...
            shop.app.shared.location.AddressType listOfAddressType = (shop.app.shared.location.AddressType) query.getSingleResult();
