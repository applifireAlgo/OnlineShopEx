...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "8", comments = "Repository for Cart Transaction table", complexity = Complexity.MEDIUM)
public class CartRepositoryImpl extends SearchInterfaceImpl implements CartRepository<Cart> {
    ...
    public List<Cart> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<shop.app.shared.retail.Cart> query = emanager.createQuery("select u from Cart u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Cart> save(List<Cart> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                shop.app.shared.retail.Cart obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            shop.app.shared.retail.Cart s = emanager.find(shop.app.shared.retail.Cart.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<Cart> findByItemId(String itemId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<shop.app.shared.retail.Cart> listOfCart = query.getResultList();
            return listOfCart;
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Cart findById(String cartId) throws Exception, SpartanPersistenceException {
        try {
            ...
            shop.app.shared.retail.Cart listOfCart = (shop.app.shared.retail.Cart) query.getSingleResult();
            return listOfCart;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
