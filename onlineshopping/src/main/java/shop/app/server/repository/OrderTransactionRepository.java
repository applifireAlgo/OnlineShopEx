...
public interface OrderTransactionRepository<T> extends SearchInterface {
    ...
    public List<T> findByOrderId(String orderId) throws Exception, SpartanPersistenceException;
