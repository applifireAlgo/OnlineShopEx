...
import shop.app.server.businessservice.OrderMainBusinessService;
...
public class OrderMainServiceImpl extends OrderMainService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<shop.app.shared.retail.OrderMain> lstordermain = orderMainrepo.findAll();
    ...
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody OrderMain entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
    ...
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody List<OrderMain> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.CREATED;
        try {
            orderMainrepo.save(entity);
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody OrderMain entity) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
    ...
    @Override
    public HttpEntity<ResponseBean> update(@RequestBody List<OrderMain> entity, @RequestHeader("isArray") boolean request) throws SpartanPersistenceException, SpartanTransactionException, Exception {
        ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            ordermainbz.update(entity);
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            shop.app.shared.retail.OrderMain lstordermain = orderMainrepo.findById((String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstordermain);
        } catch (org.springframework.transaction.TransactionException e) {
