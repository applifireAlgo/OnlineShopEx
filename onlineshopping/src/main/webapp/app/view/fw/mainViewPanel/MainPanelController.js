Ext.define('Onlineshopping.view.fw.mainViewPanel.MainPanelController', {
	extend : 'Ext.app.ViewController',
	requires : ['Ext.util.Cookies',
	            'Onlineshopping.view.login.ChangePasswordScreen'],
	...
	afterRender:function()
	{
		...
		if(cookieChangePwd=="true"){
			 var component = Ext.create("Onlineshopping.view.login.ChangePasswordScreen",
							{
								modal:true,
							});
			 component.show();
