Ext.define('Onlineshopping.onlineshopping.web.shop.controller.retailcontext.retail.PaymentInfoController', {
     extend: 'Ext.app.ViewController',
     alias: 'controller.PaymentInfoController',
     saveForm: function(but, evt) {
          ...
          var me = this;
          Ext.Ajax.request({
               url: 'secure/PaymentProcessBzServiceWS/paymentProcess',
               method: 'POST',
               jsonData: jsonData,
