Ext.define('Onlineshopping.onlineshopping.web.shop.controller.retail.CartMainController', {
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               var gridPanel = this.view.up().down('#CartGrid');
               ...
               var formPanel = this.getView().up().down("#Cart");
     ...
     loadData: function(responseData) {
          this.view.down('#Cart').getViewModel().setData(responseData.response.data);
     },
